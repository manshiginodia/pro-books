...
//                     <Link to="/">&#8592;</Link>
//                     <input type="text" placeholder="Search by title or author" onChange={this.onSearch} id='searcher' />
//                 </div>
//                 <h1 className='headersmall'>{this.props.books.filter((book) => {
